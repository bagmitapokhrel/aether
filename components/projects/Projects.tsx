...
const projects = [
  ...
  { number: "04", title: "E Commerce System ", tagline: "A complete e-commerce system with admin panel.", note: "This project was built to provide a complete e-commerce solution with an admin panel for managing products, orders, and users. It includes features like product listing, shopping cart, checkout process, and user authentication.", tech: "python Django, SQlite, HTML, CSS", demo: "https://your-ecommerce-demo.vercel.app", github: "https://github.com/bagmitapokhrel/e-commerce-system" },
];
